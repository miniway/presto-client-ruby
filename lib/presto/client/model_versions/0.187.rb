...
module Presto::Client::ModelVersions
  ...
  module V0_187
    ...
    class << AggregationNode =
        Base.new(:id, :source, :aggregations, :grouping_sets, :step, :hash_symbol, :group_id_symbol)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << OperatorStats =
        Base.new(:pipeline_id, :operator_id, :plan_node_id, :operator_type, :total_drivers, :add_input_calls, :add_input_wall, :add_input_cpu, :add_input_user, :input_data_size, :input_positions, :sum_squared_input_positions, :get_output_calls, :get_output_wall, :get_output_cpu, :get_output_user, :output_data_size, :output_positions, :blocked_wall, :finish_calls, :finish_wall, :finish_cpu, :finish_user, :memory_reservation, :revocable_memory_reservation, :system_memory_reservation, :blocked_reason, :info)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << SessionRepresentation =
        Base.new(:query_id, :transaction_id, :client_transaction_support, :user, :principal, :source, :catalog, :schema, :time_zone_key, :locale, :remote_user_address, :user_agent, :client_info, :client_tags, :start_time, :system_properties, :catalog_properties, :prepared_statements)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << StatementStats =
        Base.new(:state, :queued, :scheduled, :nodes, :total_splits, :queued_splits, :running_splits, :completed_splits, :user_time_millis, :cpu_time_millis, :wall_time_millis, :queued_time_millis, :elapsed_time_millis, :processed_rows, :processed_bytes, :root_stage)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
    ...
    class << TaskStatus =
        Base.new(:task_id, :task_instance_id, :version, :state, :self, :node_id, :failures, :queued_partitioned_drivers, :running_partitioned_drivers, :memory_reservation)
      def decode(hash)
        unless hash.is_a?(Hash)
          raise TypeError, "Can't convert #{hash.class} to Hash"
        end
